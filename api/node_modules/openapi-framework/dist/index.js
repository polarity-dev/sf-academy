                    ...
                    module: Object.keys(pathDoc)
                        ...
                        if (operationId && operationId in _this.operations) {
                            ...
                            acc[util_1.METHOD_ALIASES[method]] = (function () {
                                 ...
                                 */
                                var innerFunction = Array.isArray(operation_1)
                                    ? operation_1.map(function (middleware) {
                                        return middleware.bind({ dependencies: _this.dependencies });
                                    })
                                    : operation_1.bind({ dependencies: _this.dependencies });
        ...
        routes.forEach(function (routeItem) {
            ...
            new Set(Object.keys(pathModule).concat(Object.keys(pathDoc)).filter(util_1.byMethods)).forEach(function (methodAlias) {
                ...
                var operationHandler = pathModule[methodAlias] ||
                    routeItem.module[((pathDoc === null || pathDoc === void 0 ? void 0 : pathDoc[methodAlias]) || {}).operationId];
