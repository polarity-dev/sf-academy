...
const start = async () => {
    try {
        ...
        sseManager = await (0, sse_manager_1.createSSEManager)({
        ...
        server.get('/', async (request, reply) => {
            return reply.type('text/html').sendFile('index.html', path_1.default.join(__dirname, 'views'));
        });
        // Registra le rotte API
        server.register(api_1.default);
        server.register(htmlRoutes_1.default);
        // Avvia il server
