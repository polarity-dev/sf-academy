...
var SSEManager = class extends EventEmitter {
  constructor(options) {
    super();
    this.sseStreams = {};
    this.rooms = {};
...
var SSEStream = class extends EventEmitter {
...
export { EmitterEventsAdapter, EventsAdapter, ExpressHttpAdapter, FastifyHttpAdapter, HTTPAdapter, PostgresEventsAdapter, SSEManager, SSEStream, createSSEManager };
