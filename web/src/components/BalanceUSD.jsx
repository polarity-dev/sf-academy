...
const Usd = ({ balanceU, updater }) => {
  ...
  return (
    <div className="grid flex-1 justify-evenly justify-items-center h-full w-full md:w-1/2">
      <ToastContainer />
      <div className="text-3xl">Dollar Balance: </div>
      <div className="text-4xl">{parseFloat(balanceU).toFixed(2)}$ </div>
      <div>
        <Form
